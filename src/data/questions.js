export const IMAGES = {
  ...
  planet_mars:            require('../assets/images/planet_mars.png'),
  planet_jupiter:         require('../assets/images/planet_jupiter.png'),
  planet_saturn:          require('../assets/images/planet_saturn.jpg'),
  planet_uranus:          require('../assets/images/planet_uranus.png'),
  planet_neptun:          require('../assets/images/planet_neptun.png'),
